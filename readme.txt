### Lab Content - Git commands to use ###
...
# 1.2.  configure local git global user profile
...
# 2.3.  User below command to create a new directory for the lab content, and navigate to this newly created directory:
